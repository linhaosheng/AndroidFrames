...
public class DensityUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = FrameApp.getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = FrameApp.getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return FrameApp.getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return FrameApp.getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) FrameApp.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = FrameApp.getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = FrameApp.getResources();
