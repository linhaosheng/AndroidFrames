...
import com.linhao.androidmodule.activity.ActivityStack;
import java.io.File;
...
public class CrashHandlerUtils implements Thread.UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            PrintUtils.e("an adapter_loading_error occured when collect package info --> "+e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                PrintUtils.d(field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                PrintUtils.e("an adapter_loading_error occured when collect crash info --> "+e);
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "crash-" + DateUtils.getCurrentDate() + "-" + timestamp + ".PrintUtils";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getPath() + "/crash/";
                PrintUtils.d("path=" + path);
            ...
            PrintUtils.e("an adapter_loading_error occured while writing file... --> "+e);
        }
        return null;
    }
