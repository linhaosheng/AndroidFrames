...
public class OutdatedUtils {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(FrameApp.getContext(), id);
    }
    ...
    public static Drawable getDrawable(@DrawableRes int id,
        ...
        return ResourcesCompat.getDrawable(FrameApp.getResources(), id, theme);
    }
    ...
    public static int getColor(@ColorRes int id) {
        return ContextCompat.getColor(FrameApp.getContext(), id);
    }
    ...
    public static int getColor(@ColorRes int id, @Nullable Resources.Theme theme) {
        return ResourcesCompat.getColor(FrameApp.getResources(), id, theme);
    }
    ...
    public static ColorStateList getColorStateList(@ColorRes int id) {
        return ContextCompat.getColorStateList(FrameApp.getContext(), id);
    }
    ...
    public static ColorStateList getColorStateList(@ColorRes int id, @Nullable Resources.Theme theme) {
        return ResourcesCompat.getColorStateList(FrameApp.getResources(), id, theme);
    }
}
